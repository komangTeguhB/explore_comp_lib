...
export var Dropdown = function (_a) {
    var options = _a.options, containerClasses = _a.containerClasses, buttonClasses = _a.buttonClasses, menuClasses = _a.menuClasses, onSelect = _a.onSelect, _b = _a.defaultCaption, defaultCaption = _b === void 0 ? "Select an option" : _b;
